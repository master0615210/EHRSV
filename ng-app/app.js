...
AppEHR.config(['$httpProvider', '$routeProvider', '$locationProvider', function ($httpProvider, $routeProvider, $locationProvider) {
        ...
        $routeProvider.
                ...
                .when('/general-reports', {
                    templateUrl: 'views/general-reports.html',
                    controller: 'generalReports',
                    resolve: {
                        load: function($templateCache, $ocLazyLoad, $q) {
                            lazyDeferred = $q.defer();
                            return $ocLazyLoad.load ("controllers/generalreports.js").then(function() {
                            });
                        }
                    }
                })
                .when('/user-profile', {
                    ...
                    resolve: {
                        load: function($templateCache, $ocLazyLoad, $q) {
                            lazyDeferred = $q.defer();
                            return $ocLazyLoad.load ("controllers/userprofile.js").then(function() {
                            });
                        }
                    }
                })
